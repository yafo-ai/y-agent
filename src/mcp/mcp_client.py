...
from src.mcp.client.sse_client import sse_client
from src.mcp.client.streamable_client import streamablehttp_client
from src.mcp.error import MCPAuthError, MCPConnectionError
from src.mcp.session.client_session import ClientSession
...
class MCPClient:
    def __init__(
        ...
        if authed:
            ...
            self.provider = OAuthClientProvider(self.provider_id)
    ...
    def connect_server(
        ...
        from src.mcp.auth.auth_flow import auth
