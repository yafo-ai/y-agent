...
from src.mcp import types
from src.mcp.entities import SUPPORTED_PROTOCOL_VERSIONS, RequestContext
from src.mcp.session.base_session import BaseSession, RequestResponder

DEFAULT_CLIENT_INFO = types.Implementation(name="y-agent", version="2025-03-26")
