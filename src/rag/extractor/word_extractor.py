...
from src.rag.extractor.extractor_base import BaseExtractor
from src.rag.models.documents import Document
from src.utils import ssrf_proxy
...
class WordExtractor(BaseExtractor):
    ...
    def _extract_images_from_docx(self, doc):
        ...
        storage=FileManager("./src/upload_field/")
            ...
            if "image" in rel.target_ref:
                ...
                if rel.is_external:
                    ...
                    if response.status_code == 200:
                        ...
                        file_key = "word_files/" + file_uuid + "." + image_ext
                ...
                base64_file_key=base64.b64encode(file_key.encode('utf-8')).decode('utf-8')
                image_map[rel.target_part] = f"![image]({WEB_URL}/api/files/view/{base64_file_key})"
